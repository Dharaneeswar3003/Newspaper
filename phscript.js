const articles = [
    ...
    },
    {
        ...
        content: `
            ...
            <p> In recent years, new opinions have come to light on the concept of mini schools as a whole. The district has stated a determination to “root out inequality in its schools,” hoping to eliminate streaming - categorizing students based on academic performance. Tarek Haji, whose kids have attended the Point Grey mini school, defended the program in an interview with The Tyee, stating that mini schools provide “the perfect public school system,” and believes that “every school should have [a mini school program.]” The debate remained relatively under the radar until February 8th, 2024, when Lord Byng teachers abruptly announced the eradication of senior Byng Arts courses. The students, shocked and appalled by the sudden decision, staged a series of protests and eventually recovered one of the four terminated courses. Mr. Hartley-Folz, head of Byng Arts, has stated that he remains “proud” of his students for remaining “a tightly knit community” fostering the arts.</p>
            <p> The arts are celebrated year-round at Byng, with many opportunities for both arts and mainstream students to participate in. The Byng Coffeehouse, held 3-4 times per year, is a recurring after-school event organized by the Byng Arts student council, and open to all who wish to attend. Students gather in the school foyer, watching their classmates exhibit their talents. From angelic singing to knee-slapping comedy, Coffeehouse is an event one couldn’t miss. When they aren’t living it up on stage, students at Byng obtain greater proficiency to the arts through elective courses. While arts electives are required for mini school students, they are equally available to mainstream students with growing interests in the arts. From renowned choirs and orchestras to thrilling theatre and media productions, every student has a chance for virtuosity.</p>
            <p> This year, as Lord Byng secondary school celebrates its’ hundred year anniversary, Byng Arts mini school is preparing a grandiose celebration for its’ 25th. LBSO, the Lord Byng Symphony Orchestra, a long-standing group named by The Phonix as one of the “foremost symphony orchestras,” will be performing a composition in honour of the event. As students prepare for the upcoming jamboree, they now moreThanks to the program, Lord Byng became and remains the top secondary school in the Vancouver district.</p>
            <p>Mr Hartley-Folz views the struggles as new avenues of building community. Adaptation to new ways of teaching, sped along further by Covid, have been “trickier” to work around as Mr Hartley-Folz says, </p>
            <p>"Cultivating their friendships in their focus areas early on allows the students to feel integrated into the byng arts student body, The students of Byng Arts have had difficulty in settling for all these new aspects and although they viewed it as negatively affecting the program in some ways."</p>
            <p>The intention behind the creation of this arts program was to aid the school in discovering who it was and what it could be. Throughout the years there have been many developments and places of growth in this program that allows students to fully express themselves unashamedly. The Lord Byng Arts Mini School program has truly shown its strength and communal desire for togetherness throughout its 25 years and showcased how individuals’  passion can build a strong foundation. </p>
        `,
        category: 'School',
